...
input_ids = encoder_tokenizer('This is a long article to summarize', add_special_tokens=False, return_tensors="pt").input_ids
...
output = bert2bert(input_ids=input_ids, labels=labels.input_ids, return_dict=True)
...
print(f"Detokenized: `{decoder_tokenizer.decode(greedy_output[0], skip_special_tokens=True)}`")
